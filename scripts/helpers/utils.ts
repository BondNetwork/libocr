...
//   lensFeeCollectModule: string;
//   lensLimitedFeeCollectModule: string;
//   lensLimitedTimedFeeCollectModule: string;
//   lensRevertCollectModule: string;
//   lensFreeCollectModule: string;
//   lensFollowerOnlyReferenceModule: string;
//   lensDegreesOfSeparationReferenceModule: string;
//   lensReferenceModule: string;
// };