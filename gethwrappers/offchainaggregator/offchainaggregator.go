...
func (_OffchainAggregator *OffchainAggregatorCaller) LatestMerkleRoundData(opts *bind.CallOpts) (struct {
	RoundId      *big.Int
	BatchId      *big.Int
	...
	var out []interface{}
	err := _OffchainAggregator.contract.Call(opts, &out, "latestMerkleRoundData")
...
//
// Solidity: function latestMerkleRoundData() view returns(uint80 roundId, uint256 batchId, bytes32 merkelAnswer, uint256 startedAt, uint256 updatedAt)
func (_OffchainAggregator *OffchainAggregatorSession) LatestMerkleRoundData() (struct {
	RoundId      *big.Int
	BatchId      *big.Int
	MerkelAnswer [32]byte
	StartedAt    *big.Int
	...
	return _OffchainAggregator.Contract.LatestMerkleRoundData(&_OffchainAggregator.CallOpts)
}

// LatestMerkleRoundData is a free data retrieval call binding the contract method 0xc00675d6.
//
// Solidity: function latestMerkleRoundData() view returns(uint80 roundId, uint256 batchId, bytes32 merkelAnswer, uint256 startedAt, uint256 updatedAt)
func (_OffchainAggregator *OffchainAggregatorCallerSession) LatestMerkleRoundData() (struct {
	RoundId      *big.Int
	BatchId      *big.Int
	MerkelAnswer [32]byte
	StartedAt    *big.Int
...
func (_OffchainAggregator *OffchainAggregatorFilterer) FilterAnswerUpdated(opts *bind.FilterOpts, currentRoot [][32]byte, currentBatchId []*big.Int, roundId []*big.Int) (*OffchainAggregatorAnswerUpdatedIterator, error) {
	...
	logs, sub, err := _OffchainAggregator.contract.FilterLogs(opts, "AnswerUpdated", currentRootRule, currentBatchIdRule, roundIdRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event AnswerUpdated(bytes32 indexed currentRoot, uint256 indexed currentBatchId, uint256 indexed roundId, uint256 updatedAt)
func (_OffchainAggregator *OffchainAggregatorFilterer) WatchAnswerUpdated(opts *bind.WatchOpts, sink chan<- *OffchainAggregatorAnswerUpdated, currentRoot [][32]byte, currentBatchId []*big.Int, roundId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _OffchainAggregator.contract.WatchLogs(opts, "AnswerUpdated", currentRootRule, currentBatchIdRule, roundIdRule)
	if err != nil {
		return nil, err
	}
